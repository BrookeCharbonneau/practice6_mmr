...
apa.cor.table(analytic.data, filename="Table1.doc", table.number = 1)
...
my.plot <- my.plot+annotate("text", x = -1, y = 55.5, label = "+1 SD Preparation")
my.plot <- my.plot+annotate("text", x = -1, y =30.5, label = "-1 SD Preparation")
